      ...
      if (user) {
        ...
        if (hasLocalOnlyItems) {
          ...
          if (syncedData) {
            ...
            // Only set draft from DB if we don't already have a local draft
            setDonationDraft((currentDraft) => currentDraft ?? syncedData.draft);
          ...
          setDonationDraft((currentDraft) => currentDraft ?? dbData.draft);
