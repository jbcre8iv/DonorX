...
interface WidgetClientProps {
  nonprofit: Nonprofit;
  initialWidget: WidgetToken | null;
}

export function WidgetClient({ nonprofit, initialWidget }: WidgetClientProps) {
  const [widget, setWidget] = React.useState<WidgetToken | null>(initialWidget);
  ...
  const [formData, setFormData] = React.useState({
    name: `${nonprofit.name} Website Widget`,
