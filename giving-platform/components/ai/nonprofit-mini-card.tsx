...
export function NonprofitMiniCard({ id, name, onClick }: NonprofitMiniCardProps) {
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-3 py-2 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-lg text-sm transition-colors group my-1 text-left"
    >
